...
const Address = () => {
  ...
  useEffect(() => {
    ...
    const getListAddressSave = () => {
      const apiUrl = "https://mcfabric.netlify.app/api/user/list/address";
      const config = {
        headers: {
  ...
  const handleAddAddress = (e) => {
    ...
    const apiUrl = "https://mcfabric.netlify.app/api/user/add/address";
    const requestData = {
  ...
  const handleDeleteAddress = (id) => {
    ...
    if (shouldDelete) {
      const apiUrl =
        "https://mcfabric.netlify.app/api/user/delete/address/" + id;
      const config = {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
